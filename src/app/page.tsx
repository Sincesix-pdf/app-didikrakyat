...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="py-20 bg-[var(--color-foreground)]"></section>

      {/* PENGENALAN & MASALAH */}
      <section className="py-20 bg-[var(--color-background)]">
        <div className="mx-auto max-w-6xl px-4">
          <h2 className="text-3xl font-bold text-center text-[var(--color-foreground)]">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Pelajar */}
            <div className="p-6 bg-white rounded-xl shadow-md border border-[var(--color-foreground)]">
              <h3 className="text-lg font-semibold text-[var(--color-foreground)] mb-3">Untuk Pelajar</h3>
            ...
            {/* Usahawan */}
            <div className="p-6 bg-white rounded-xl shadow-md border border-[var(--color-foreground)]">
              <h3 className="text-lg font-semibold text-[var(--color-foreground)] mb-3">Untuk Usahawan</h3>
              <p className="text-[var(--color-foreground)]">
            ...
            {/* Suri Rumah */}
            <div className="p-6 bg-white rounded-xl shadow-md border border-[var(--color-foreground)]">
              <h3 className="text-lg font-semibold text-[var(--color-foreground)] mb-3">Untuk Suri Rumah</h3>
              <p className="text-[var(--color-foreground)]">
      ...
      {/* FUNGSI UTAMA */}
      <section id="features" className="py-20 bg-[var(--color-foreground)]">
        <div className="mx-auto max-w-4xl px-4">
          <h2 className="text-3xl font-semibold text-center text-[var(--color-background)] mb-12">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 bg-[var(--color-background)] rounded-xl overflow-hidden">
            {/* 1. Pelajar */}
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-foreground)]">
              <div className="h-12 w-12 text-[var(--color-foreground)]">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <h3 className="text-center font-semibold text-[var(--color-foreground)]">Tutor & Homework</h3>
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-foreground)]">
              ...
              <h3 className="text-center font-semibold text-[var(--color-foreground)]">Bantuan Belajar IPT</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-foreground)]">
              ...
              <h3 className="text-center font-semibold text-[var(--color-foreground)]">Pengurusan Rumah Tangga</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-foreground)]">
              ...
              <h3 className="text-center font-semibold text-[var(--color-foreground)]">Didik Usahawan</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-foreground)]">
              ...
              <h3 className="text-center font-semibold text-[var(--color-foreground)]">Panduan Hidup & Kemahiran</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-foreground)]">
              ...
              <h3 className="text-center font-semibold text-[var(--color-foreground)]">Pelajaran Agama Islam</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
