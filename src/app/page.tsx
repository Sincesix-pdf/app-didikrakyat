        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 bg-[var(--color-background)] rounded-xl overflow-hidden">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-background)]">
              ...
              <h3 className="text-center font-semibold">Tutor & Homework</h3>
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-background)]">
              ...
              <h3 className="text-center font-semibold">Bantuan Belajar IPT</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-background)]">
              ...
              <h3 className="text-center font-semibold">Pengurusan Rumah Tangga</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-background)]">
              ...
              <h3 className="text-center font-semibold">Didik Usahawan</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-background)]">
              ...
              <h3 className="text-center font-semibold">Panduan Hidup & Kemahiran</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
            ...
            <div className="min-h-[250px] flex flex-col items-center justify-center p-6 bg-white border border-[var(--color-background)]">
              ...
              <h3 className="text-center font-semibold">Pelajaran Agama Islam</h3>
              <p className="mt-2 text-center text-slate-600 text-sm">
